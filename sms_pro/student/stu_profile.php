...
$std = $_SESSION['studentname'];       
$sql="select * from  student_login where StudentName='$std'";
...
$img="<img class='img-fluid w-50'src=images/$row[image]>" ;
