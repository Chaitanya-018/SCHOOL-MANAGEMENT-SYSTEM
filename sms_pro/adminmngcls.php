                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="adminmngcls.php" class="text-dark ms-auto mb-3 mb-sm-0 text-decoration-none"> View all Classes</a>
                    </div>
                      ...
                      <table class="table">
                        ...
                        if(mysqli_num_rows($data)>0){
                          while($row=mysqli_fetch_array($data)){
                            ...
                            echo"<td>";
                            echo '<a href="upmanclass.php?id='.$row['id'].'"><i class="bi bi-pencil-square"></i></a>' .""."||";
                            echo '<a href="clas_del.php?id='.$row['id'].'""><i class="bi bi-trash3"></i></a>';
                            echo "</td>";
                           $i++;
                          }
                        }else{
