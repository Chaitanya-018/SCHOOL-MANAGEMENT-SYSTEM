                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        $get = "select * from notice_stu where hide='0'";
                        ...
                        if(mysqli_num_rows($data)>0){
                          while($row=mysqli_fetch_array($data)){
                            ...
                            echo "<td>".$row['notice_mess']."</td>";
                            
                            echo "<td>".$row['creation_date']."</td>";
                      
                            echo"<td>";
                            echo '<a href="up_notice.php?id='.$row['id'].'"><i class="bi bi-pencil-square"></i></a>' .""."||";
                            echo '<a href="del_notice.php?id='.$row['id'].'"><i class="bi bi-trash3"></i></a>';
                            echo "</td>";
                            $i++;
